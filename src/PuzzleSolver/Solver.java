...
public class Solver {
    ...
    private ArrayList<Node> unexpanded = new ArrayList<>(); // Holds unexpanded node list
    private ArrayList<Node> expanded = new ArrayList<>();   // Holds expanded node list
    private Node rootNode;                                      // Node representing initial state
     ...
     */
    private Solver(char[][] initialBoard) {
    ...
    /*
       ...
       The PrintWriter argument is used to specify where the output should be directed.
     */
    private void reportSolution(Node n, PrintWriter output) {
